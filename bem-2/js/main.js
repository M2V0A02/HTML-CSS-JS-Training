...
$('.horizontal-charts__item').each(function(){
    ...
    $(this).find('.horizontal-charts__line').append('<div style="width:' + percent + '%; height: 2px; background-color: #1D1D1D; position: absolute"> </div>');
    $(this).find('.horizontal-charts__percent').css('left', 'calc(' + percent + '% - 9px)');
});
